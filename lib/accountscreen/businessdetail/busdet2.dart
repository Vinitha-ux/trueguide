...
class _BusinessDetailScreenState extends State<BusinessDet2> {
  ...
  Widget build(BuildContext context) {
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          onPressed: () {
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => kycc3()),
            );
          },
    ...
    items: ["Mr.", "Mrs.", "Ms."]
        .map((String title) => DropdownMenuItem(
    value: title,
    child: Text(title),
    ))
        .toList(),
    ...
    border: OutlineInputBorder(),
                ...
                TextButton(
                  ...
                  child: Text("+ Add Another Mobile Number"),
                ),
                SizedBox(height: 10),
                // WhatsApp Number
                Row(
                ...
                Wrap(
                  ...
                  children: [
                    ...
                    "Fri",
                    "Sat"
                  ].map((day) => Chip(label: Text(day))).toList(),
                ),
                CheckboxListTile(
                ...
                TextButton(
                  onPressed: () {},
                  child: Text("+ Add Another Timeslot"),
                ),
                SizedBox(height: 20),
                // Save Button
                SizedBox(
